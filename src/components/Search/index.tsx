...
const Search: FC<Search> = ({ term, search }) => {
  ...
  return (
    <div className="flex items-center flex-grow w-full gap-4 sm:w-auto">
      <div className="flex items-center flex-grow w-full gap-2 px-3 py-2 bg-opacity-50 border rounded focus-within:ring-2 ring-blue search-bar-color bg-dark-900 sm:w-auto">
